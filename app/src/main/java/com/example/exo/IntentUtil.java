...
public class IntentUtil {
 ...
 // public static final String URI_EXTRA = "uri";
  ...
  public static final String URL = "https://admdn1.cdn.mangomolo.com/adsports1/smil:adsports1.stream.smil/playlist.m3u8";
  ...
  public static List<MediaItem> createMediaItemsFromIntent(Intent intent) {
    ...
    if (ACTION_VIEW_LIST.equals(intent.getAction())) {
      int index = 0;
      while (intent.hasExtra(URL + "_" + index)) {
        Uri uri = Uri.parse(intent.getStringExtra(URL + "_" + index));
  ...
  public static void addToIntent(List<MediaItem> mediaItems, Intent intent) {
    ...
    if (mediaItems.size() == 1) {
      ...
      for (int i = 0; i < mediaItems.size(); i++) {
        ...
        intent.putExtra(URL + ("_" + i), localConfiguration.uri.toString());
